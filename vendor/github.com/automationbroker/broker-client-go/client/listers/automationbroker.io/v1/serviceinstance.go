...
// List lists all ServiceInstances in the indexer for a given namespace.
func (s serviceInstanceNamespaceLister) List(selector labels.Selector) (ret []*v1.ServiceInstance, err error) {
...
// Get retrieves the ServiceInstance from the indexer for a given namespace and name.
func (s serviceInstanceNamespaceLister) Get(name string) (*v1.ServiceInstance, error) {
