	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.AutomationbrokerV1().Bundles(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AutomationbrokerV1().Bundles(namespace).Watch(options)
			},
		},
		&automationbroker_io_v1.Bundle{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bundleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&automationbroker_io_v1.Bundle{}, f.defaultInformer)
}

func (f *bundleInformer) Lister() v1.BundleLister {
	return v1.NewBundleLister(f.Informer().GetIndexer())
}
